...
puchar_byts_t rand_get_sd_byts()
{
	return RNG_SEED_BYTES;
}

puchar_byts_t rand_init(unsigned char * s, unsigned long long s_byts)
{
...
puchar_byts_t rand_byts(unsigned long long r_byts, unsigned char * r)
{
