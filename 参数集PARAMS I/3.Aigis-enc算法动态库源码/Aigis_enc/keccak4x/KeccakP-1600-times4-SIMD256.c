...
#ifndef _WIN64
    #define LOAD4_64(a, b, c, d)    _mm256_set_epi32(a>>32, a, b>>32, b, c>>32, c, d>>32,d)
#else
...
static const UINT64 rho56[4] = {0x0007060504030201, 0x080F0E0D0C0B0A09, 0x1017161514131211, 0x181F1E1D1C1B1A19};
    ...
    #define PERM128( a, b, c )      _mm256_castps_si256(_mm256_permute2f128_ps(_mm256_castsi256_ps(a), _mm256_castsi256_ps(b), c))
